...
public class Constants {
    ...
    public static DateTimeFormatter DATE_TIME_FORMATTER = DateTimeFormatter.ofPattern(EWM_TIMESTAMP_PATTERN);

    public static LocalDateTime MIN_TIME = LocalDateTime.of(2022, 8, 25, 12, 0);

    public static int HOUR_OF_SEC = 3600;

    public static String CHECK_TIME_FILTER = "checking request time parameters";
    public static String CHECK_EVENT_TIME = "checking event time to add/update";
}