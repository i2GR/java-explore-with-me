...
public class EventAdminServiceImpl extends AbstractEventCommonService implements EventAdminService {
    ...
    public List<EventOutputFullDto> getEventListByConditions(List<Long> userIds,
        ...
        //userIds = userIds == null ? List.of() : userIds;
        states = states == null ? List.of(EventState.values()) : states;
        //categoryIds = categoryIds == null ? List.of() : categoryIds;
        LocalDateTime start = parseOrSetDefaultTime(rangeStart, MIN_TIME, "start");
        LocalDateTime end = parseOrSetDefaultTime(rangeEnd, MIN_TIME.plusYears(100), "end");
